...
| `NEXT_PUBLIC_UPLOAD_TRANSPORT`               | The transport for file uploads (database, s3, or gcs).                                                    |
...
| `NEXT_PRIVATE_GCS_PROJECT_ID`                | The Google Cloud project ID for GCS storage.                                                        |
| `NEXT_PRIVATE_GCS_CLIENT_EMAIL`              | The service account email for GCS storage.                                                          |
| `NEXT_PRIVATE_GCS_PRIVATE_KEY`               | The private key for the GCS service account.                                                        |
| `NEXT_PRIVATE_GCS_BUCKET_NAME`               | The GCS bucket name for file storage.                                                              |
