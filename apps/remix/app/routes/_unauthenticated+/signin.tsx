...
// Using plain <a> and manual redirect to avoid Remix type resolution issues
...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  if (isAuthenticated)
    return new Response(null, { status: 302, headers: { Location: '/documents' } });
        ...
        {env('NEXT_PUBLIC_DISABLE_SIGNUP') !== 'true' && (
          <p className="text-muted-foreground mt-6 text-center text-sm">
            <Trans>
              ...
              <a href="/signup" className="text-documenso-700 duration-200 hover:opacity-70">
                Sign up
              </a>
            </Trans>
          </p>
